...
nBlocks = 2 # Total number of blocks in experiement
...
for nt in range(0,(nTrials_per_block*nBlocks)+1): # + 1 TRUE?? 
    ...
    lenStims = random.randint(5,7) # longeure de la liste T2
    ...
    dur = int(numpy.random.uniform(low=10000, high=30000) # for 1 trial --> constant hazard rate !!!! --> trial duration ! en moyenne 20 seconde 
